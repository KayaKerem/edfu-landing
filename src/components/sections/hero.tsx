    ...
    <section id="hero" className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-4 pt-28 sm:pt-40 pb-16 text-center">
        ...
        >
          <Link
            href={`${prefix}/pricing`}
            className="bg-primary h-10 flex items-center justify-center text-sm font-normal tracking-wide rounded-md text-primary-foreground whitespace-nowrap w-32 px-4 shadow-[inset_0_1px_2px_rgba(255,255,255,0.25),0_3px_3px_-1.5px_rgba(16,24,40,0.06),0_1px_1px_rgba(16,24,40,0.08)] border border-white/[0.12] hover:bg-primary/80 transition-all ease-out active:scale-95"
          >
            {dict.ctaPrimary}
          </Link>
          <a
            href="https://app.edfu.ai"
            className="h-10 flex items-center justify-center whitespace-nowrap w-32 px-5 text-sm font-normal tracking-wide text-foreground rounded-md transition-all ease-out active:scale-95 bg-background border border-border hover:bg-accent"
          >
            {dict.ctaSecondary}
          </a>
        </motion.div>
