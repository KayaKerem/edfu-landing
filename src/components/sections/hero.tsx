  ...
  return (
    <section id="hero" className="relative overflow-hidden">
      <div className="mx-auto max-w-6xl px-4 pt-28 pb-16 text-center">
        ...
        {/* Heading */}
        <h1 className="text-4xl md:text-5xl lg:text-[3rem] xl:text-6xl font-medium text-balance text-center text-foreground leading-tight" style={{ letterSpacing: "-0.05em" }}>
