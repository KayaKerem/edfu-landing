...
function IntegrationOrbits() {
  return (
    <div className="relative flex h-full w-full items-center justify-center overflow-hidden" style={{ paddingTop: "60%" }}>
      {/* Gradient fills between orbits */}
      <div className="absolute left-1/2 -translate-x-1/2" style={{ top: "60%", transform: "translate(-50%, -50%)" }}>
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 size-[160px] rounded-full bg-black/[0.03]" />
      </div>

      {/* Orbiting area centered lower */}
      <div className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center" style={{ top: "60%", transform: "translate(-50%, -50%)", width: 400, height: 400 }}>
        {/* Center – Edfu logo */}
        <img src="/logo.svg" alt="Edfu" className="size-16 rounded-xl relative z-10" />
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 z-20 h-12 w-full bg-gradient-to-t from-background to-transparent" />
    </div>
  );
}
