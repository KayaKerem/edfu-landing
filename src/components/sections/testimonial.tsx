export function Testimonial() {
  return (
    <section className="relative z-20 bg-white dark:bg-[oklch(0.14_0.005_250)] py-16 sm:py-20 px-8 sm:px-12 lg:px-20">
      <div className="mx-auto max-w-3xl">
        <blockquote className="text-2xl font-medium leading-relaxed tracking-tight" style={{ fontFamily: "var(--font-geist)" }}>
